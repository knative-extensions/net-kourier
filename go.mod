...
require (
	...
	knative.dev/pkg v0.0.0-20200416021448-f68639f04b39
	knative.dev/serving v0.14.1-0.20200416124848-7633ea2f50bb
	knative.dev/test-infra v0.0.0-20200416141448-2f62d241ccc0
)
