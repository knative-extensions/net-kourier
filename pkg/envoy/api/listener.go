...
import (
	...
	v2 "github.com/envoyproxy/go-control-plane/envoy/config/listener/v3"
...
func NewHTTPListener(manager *hcm.HttpConnectionManager, port uint32) (*v2.Listener, error) {
...
func NewHTTPSListenerWithSNI(manager *hcm.HttpConnectionManager, port uint32, sniMatches []*SNIMatch) (*v2.Listener, error) {
