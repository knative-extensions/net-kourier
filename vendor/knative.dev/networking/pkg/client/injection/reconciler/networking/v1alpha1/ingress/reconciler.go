...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.Ingress, desired *v1alpha1.Ingress) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.Ingress, desiredFinalizers sets.Set[string]) (*v1alpha1.Ingress, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredServerSideApply(ctx context.Context, resource *v1alpha1.Ingress, desiredFinalizers sets.Set[string]) (*v1alpha1.Ingress, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredMergePatch(ctx context.Context, resource *v1alpha1.Ingress, desiredFinalizers sets.Set[string]) (*v1alpha1.Ingress, error) {
	// Don't modify the informers copy.
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1alpha1.Ingress, reconcileEvent reconciler.Event) (*v1alpha1.Ingress, error) {
	...
	if err != nil {
		...
		getter := r.Client.NetworkingV1alpha1().Ingresses(resource.Namespace)
